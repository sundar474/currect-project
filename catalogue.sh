...
cp /home/centos/Successful-Project/catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
mongo --host mongodb.sadhusundar.xyz </app/schema/catalogue.js &>>$LOGFILE
